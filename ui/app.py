...
class TaskPlanner(ctk.CTk):
    ...
    def show_page(self, page_name, **kwargs):
        ...
        if page_name == "home":
            ...
            self.current_frame = TaskFormPage(self.content_frame, self.db, self.show_page)
        elif page_name == "edit_task":
            self.current_frame = TaskFormPage(self.content_frame, self.db, self.show_page, task_id=kwargs.get("task_id"))
        elif page_name == "import":
            self.current_frame = ImportExportPage(self.content_frame, self.db, mode="import")
        elif page_name == "export":
            self.current_frame = ImportExportPage(self.content_frame, self.db, mode="export")
